...
$modversion['releasedate'] = "Friday: September 16, 2011";
...
// Blocks
$modversion['blocks'][1]['file'] = "pageflip_block_pageflip.php";
$modversion['blocks'][1]['name'] = 'Maquee' ;
$modversion['blocks'][1]['description'] = "Shows pageflip";
$modversion['blocks'][1]['show_func'] = "b_pageflip_block_pageflip_show";
$modversion['blocks'][1]['edit_func'] = "b_pageflip_block_pageflip_edit";
$modversion['blocks'][1]['options'] = "0";
$modversion['blocks'][1]['template'] = "pageflip_block_pageflip.html" ;
