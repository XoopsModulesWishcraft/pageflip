 ...
 * @access 		public
 */
class PageflipFormSelectPagesMode extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PageflipFormSelectPagesMode($caption, $name, $value = null, $size = 1, $multiple = false, $none=false)
    {
        ...
        foreach(array('_MI_PAGEFLIP_MODE_LANDSCAPE','_MI_PAGEFLIP_MODE_PORTTRAIT') as $mode)
