 ...
 * @access 		public
 */
class PageflipFormSelectShadowType extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PageflipFormSelectShadowType($caption, $name, $value = null, $size = 1, $multiple = false, $none=false)
    {
