 ...
 * @package kernel
 */
class PageflipChapters extends XoopsObject
{

	var $_ModConfig = NULL;
	var $_Mod = NULL;
	
    function PageflipChapters($id = null)
    {
    ...
    function getForm() {
    	return pageflip_chapters_get_form($this, false);
    }
    
    function toArray() {
    	$ret = parent::toArray();
    	$ele = pageflip_chapters_get_form($this, true);
...
* @package kernel
*/
class PageflipChaptersHandler extends XoopsPersistableObjectHandler
{
	...
	function __construct(&$db) 
    {
    	...
    	$this->db = $db;
        parent::__construct($db, 'pageflip_chapters', 'PageflipChapters', "cid", "name");
    }
