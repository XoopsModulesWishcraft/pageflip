 ...
 * @access 		public
 */
class PageflipFormSelectLanguage extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PageflipFormSelectLanguage($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
        ...
        $language_handler = xoops_getmodulehandler('xlanguage_ext', 'pageflip');
		foreach($language_handler->getLanguages() as $lang => $name)
			$this->addOption($lang, $name);
    }
     ...
     *
     * @seealso TbForm::renderValidationJS
     */
