 ...
 * @access 		public
 */
class PageflipFormSelectTFD extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PageflipFormSelectTFD($caption, $name, $value = null, $size = 1, $multiple = false, $none=false)
    {
        ...
        foreach(array('_MI_PAGEFLIP_TRUE','_MI_PAGEFLIP_FALSE','_MI_PAGEFLIP_DEFAULT') as $mode)
