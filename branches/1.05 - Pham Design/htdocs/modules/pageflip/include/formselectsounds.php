 ...
 * @access 		public
 */
class PageflipFormSelectSounds extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PageflipFormSelectSounds($caption, $name, $value = null, $size = 1, $multiple = false, $none = true)
    {
        ...
        foreach($sounds as $id=>$sound) {
        	...
        	if (strtolower($fileparts[sizeof($fileparts)-1])=='mp3') {
