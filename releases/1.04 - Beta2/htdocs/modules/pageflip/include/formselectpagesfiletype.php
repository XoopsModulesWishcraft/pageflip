 ...
 * @access 		public
 */
class PageflipFormSelectPagesFiletype extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PageflipFormSelectPagesFiletype($caption, $name, $value = null, $size = 1, $multiple = false, $none=false)
    {
        ...
        foreach(array('_MI_PAGEFLIP_FILETYPE_JPG','_MI_PAGEFLIP_FILETYPE_PNG','_MI_PAGEFLIP_FILETYPE_GIF','_MI_PAGEFLIP_FILETYPE_SWF') as $mode)
