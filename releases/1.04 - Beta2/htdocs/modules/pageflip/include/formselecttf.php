 ...
 * @access 		public
 */
class PageflipFormSelectTF extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PageflipFormSelectTF($caption, $name, $value = null, $size = 1, $multiple = false, $none=false)
    {
        ...
        foreach(array('_MI_PAGEFLIP_TRUE','_MI_PAGEFLIP_FALSE') as $mode)
