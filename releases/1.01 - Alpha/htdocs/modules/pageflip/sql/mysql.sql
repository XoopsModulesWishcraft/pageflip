...
CREATE TABLE `pageflip_books` (
  ...
  `staticShadowType` ENUM('Asymmetric','Symmetric','_MI_PAGEFLIP_DEFAULT') DEFAULT 'Asymmetric',
  `staticShadowDepth` INT(4) UNSIGNED DEFAULT '1',
  `staticShadowsDarkColor` VARCHAR(6) DEFAULT '000000',
  `staticShadowsLightColor` VARCHAR(6) DEFAULT 'FFFFFF',
  `dynamicShadowDepth` INT(4) UNSIGNED DEFAULT '1',
  `dynamicShadowLightColor` VARCHAR(6) DEFAULT 'FFFFFF',
  `dynamicShadowDarkColor` VARCHAR(6) DEFAULT '000000',
  ...
  `dropShadowEnabled` ENUM('_MI_PAGEFLIP_TRUE','_MI_PAGEFLIP_FALSE') DEFAULT '_MI_PAGEFLIP_TRUE',
  `dropShadowHideWhenFlipping` ENUM('_MI_PAGEFLIP_TRUE','_MI_PAGEFLIP_FALSE') DEFAULT '_MI_PAGEFLIP_TRUE',
...
CREATE TABLE `pageflip_pages` (
  ...
  `showStaticShadow` enum('_MI_PAGEFLIP_TRUE','_MI_PAGEFLIP_FALSE','_MI_PAGEFLIP_DEFAULT') DEFAULT '_MI_PAGEFLIP_DEFAULT',
