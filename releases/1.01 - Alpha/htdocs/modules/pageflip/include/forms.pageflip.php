<?php
	...
	function pageflip_books_get_form($object, $as_array=false) {
		...
		$ele['bookHeight'] = new XoopsFormText(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_REFERENCE:''), $id.'[bookHeight]', ($as_array==false?5:5), 5, $object->getVar('bookHeight'));
		$ele['bookHeight']->setDescription(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_REFERENCE_DESC:''));
		...
		$ele['staticShadowType'] = new PageflipFormSelectShadowType(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_STATICSHADOWTYPE:''), $id.'[staticShadowType]', $object->getVar('staticShadowType'));
		$ele['staticShadowType']->setDescription(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_STATICSHADOWTYPE_DESC:''));
		$ele['staticShadowDepth'] = new XoopsFormText(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_STATICSHADOWDEPTH:''), $id.'[staticShadowDepth]', ($as_array==false?5:5), 5, $object->getVar('staticShadowDepth'));
		$ele['staticShadowDepth']->setDescription(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_STATICSHADOWDEPTH_DESC:''));
		...
		$ele['dynamicShadowDepth'] = new XoopsFormText(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_DYNAMICSHADOWDEPTH:''), $id.'[dynamicShadowDepth]', ($as_array==false?5:5), 5, $object->getVar('dynamicShadowDepth'));
		$ele['dynamicShadowDepth']->setDescription(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_DYNAMICSHADOWDEPTH_DESC:''));
		$ele['dynamicShadowDarkColor'] = new XoopsFormText(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_DYNAMICSHADOWDARKCOLOUR:''), $id.'[dynamicShadowDarkColor]', ($as_array==false?7:7), 6, $object->getVar('dynamicShadowDarkColor'));
		$ele['dynamicShadowDarkColor']->setDescription(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_DYNAMICSHADOWDARKCOLOUR_DESC:''));
		$ele['dynamicShadowLightColor'] = new XoopsFormText(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_DYNAMICSHADOWLIGHTCOLOUR:''), $id.'[dynamicShadowLightColor]', ($as_array==false?7:7), 6, $object->getVar('dynamicShadowLightColor'));
		$ele['dynamicShadowLightColor']->setDescription(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_DYNAMICSHADOWLIGHTCOLOUR_DESC:''));
		...
		$ele['freezeOnFlip'] = new PageflipFormSelectTF(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_FEEZEONFLIP:''), $id.'[freezeOnFlip]', $object->getVar('freezeOnFlip'));
		...
		$ele['dropShadowEnabled'] = new PageflipFormSelectTF(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_DROPSHADOWENABLED:''), $id.'[dropShadowEnabled]', $object->getVar('dropShadowEnabled'));
		$ele['dropShadowEnabled']->setDescription(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_DROPSHADOWENABLED_DESC:''));
		$ele['dropShadowHideWhenFlipping'] = new PageflipFormSelectTF(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_DROPSHADOWHIDEWHENFLIPPING:''), $id.'[dropShadowHideWhenFlipping]', $object->getVar('dropShadowHideWhenFlipping'));
		$ele['dropShadowHideWhenFlipping']->setDescription(($as_array==false?_FRM_PAGEFLIP_FORM_BOOKS_DROPSHADOWHIDEWHENFLIPPING_DESC:''));
		...
		if (strlen($object->getVar('backgroundColor'))) {
	...
	function pageflip_pages_get_form($object, $as_array=false) {
		...
		$ele['bid'] = new PageflipFormSelectBooks(($as_array==false?_FRM_PAGEFLIP_FORM_PAGES_BOOKS:''), $id.'[bid]', $object->getVar('bid'));
		...
		$ele['showStaticShadow'] = new PageflipFormSelectTFD(($as_array==false?_FRM_PAGEFLIP_FORM_PAGES_SHOWSTATICSHADOW:''), $id.'[showStaticShadow]', $object->getVar('showStaticShadow'));
		$ele['showStaticShadow']->setDescription(($as_array==false?_FRM_PAGEFLIP_FORM_PAGES_SHOWSTATICSHADOW_DESC:''));
