 ...
 * @access 		public
 */
class PageflipFormSelectCornerPosition extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PageflipFormSelectCornerPosition($caption, $name, $value = null, $size = 1, $multiple = false, $none=false)
    {
        ...
        foreach(array('_MI_PAGEFLIP_BOTTOMRIGHT','_MI_PAGEFLIP_TOPRIGHT','_MI_PAGEFLIP_BOTTOMLEFT','_MI_PAGEFLIP_TOPLEFT') as $mode)
