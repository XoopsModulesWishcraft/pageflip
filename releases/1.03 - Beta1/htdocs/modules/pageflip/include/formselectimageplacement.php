 ...
 * @access 		public
 */
class PageflipFormSelectImagePlacement extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PageflipFormSelectImagePlacement($caption, $name, $value = null, $size = 1, $multiple = false, $none=false)
    {
        ...
        foreach(array('_MI_PAGEFLIP_TOP_LEFT','_MI_PAGEFLIP_CENTER','_MI_PAGEFLIP_FIT') as $mode)
