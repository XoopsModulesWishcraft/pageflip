 ...
 * @access 		public
 */
class PageflipFormSelectCSSMode extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PageflipFormSelectCSSMode($caption, $name, $value = null, $size = 1, $multiple = false, $none=false)
    {
        ...
        foreach(array('_MI_PAGEFLIP_CSS_FOOTER','_MI_PAGEFLIP_CSS_PAGINATION','_MI_PAGEFLIP_CSS_CONTENTS','_MI_PAGEFLIP_CSS_MENU','_MI_PAGEFLIP_CSS_ALTMSG','_MI_PAGEFLIP_CSS_ALTLINK','_MI_PAGEFLIP_CSS_EXTRA') as $mode)
