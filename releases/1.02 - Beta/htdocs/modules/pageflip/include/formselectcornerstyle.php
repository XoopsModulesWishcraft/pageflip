 ...
 * @access 		public
 */
class PageflipFormSelectCornerStyle extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PageflipFormSelectCornerStyle($caption, $name, $value = null, $size = 1, $multiple = false, $none=false)
    {
        ...
        foreach(array('_MI_PAGEFLIP_FIRSTPAGEONLY','_MI_PAGEFLIP_EACHPAGE','_MI_PAGEFLIP_MANUALLY') as $mode)
