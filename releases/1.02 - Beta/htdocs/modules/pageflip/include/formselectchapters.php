 ...
 * @access 		public
 */
class PageflipFormSelectChapters extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PageflipFormSelectChapters($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		foreach($chapters_handler->getObjects(NULL, true) as $cid => $chapter)
			$this->addOption($cid, $chapter->getVar('name'));
    }
