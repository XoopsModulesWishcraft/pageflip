 ...
 * @access 		public
 */
class PageflipFormSelectPreloaderType extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PageflipFormSelectPreloaderType($caption, $name, $value = null, $size = 1, $multiple = false)
    {
        ...
        foreach(array('_MI_PAGEFLIP_PROGESSBAR','_MI_PAGEFLIP_ROUND','_MI_PAGEFLIP_THIN','_MI_PAGEFLIP_DOTS','_MI_PAGEFLIP_GRADIENTWHEEL','_MI_PAGEFLIP_GEARWHEEL','_MI_PAGEFLIP_LINE','_MI_PAGEFLIP_ANIMATEDBOOK','_MI_PAGEFLIP_NONE') as $mode)
			$this->addOption($mode, (defined($mode)?constant($mode):$mode));
    }
