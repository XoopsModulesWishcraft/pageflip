...
class PageflipBooks extends XoopsObject
{
	...
	var $_settingfields = array('stageWidth', 'stageHeight', 'bookWidth', 'bookHeight', 'scaleContent', 'centerContent',
								...
								'staticShadowType', 'staticShadowDepth', 'staticShadowsDarkColor', 'staticShadowsLightColor', 'dynamicShadowDepth',
								'dynamicShadowDarkColor', 'dynamicShadowLightColor', 'moveSpeed', 'gotoSpeed', 'rigidPageSpeed',
								...
								'centerBook', 'useCustomCursors', 'dropShadowEnabled', 'dropShadowHideWhenFlipping', 'backgroundImage',
								'backgroundImagePlacement', 'printEnabled', 'printTitle', 'downloadURL', 'downloadTitle',
								'downloadSize', 'downloadComplete');
    ...
    function PageflipBooks($id = null)
    {
        ...
        $this->initVar('staticShadowType', XOBJ_DTYPE_ENUM, '_MI_PAGEFLIP_ASYMMETRIC', false, false, false, array('_MI_PAGEFLIP_ASYMMETRIC','_MI_PAGEFLIP_SYMMETRIC','_MI_PAGEFLIP_DEFAULT'));
        $this->initVar('staticShadowDepth', XOBJ_DTYPE_INT, 1, false);
        ...
        $this->initVar('dynamicShadowDepth', XOBJ_DTYPE_INT, 1, false);
        $this->initVar('dynamicShadowDarkColor', XOBJ_DTYPE_TXTBOX, '000000', false, 6);
        $this->initVar('dynamicShadowLightColor', XOBJ_DTYPE_TXTBOX, 'FFFFFF', false, 6);
		...
		$this->initVar('dropShadowEnabled', XOBJ_DTYPE_ENUM, '_MI_PAGEFLIP_TRUE', false, false, false, array('_MI_PAGEFLIP_TRUE','_MI_PAGEFLIP_FALSE'));
		$this->initVar('dropShadowHideWhenFlipping', XOBJ_DTYPE_ENUM, '_MI_PAGEFLIP_TRUE', false, false, false, array('_MI_PAGEFLIP_TRUE','_MI_PAGEFLIP_FALSE'));
    ...
    function getCSS() {
    	...
    	foreach($this->_cssHandler->getObjects($criteria, true) as $cssid => $css) {
    		$cssarr[$cssid] = $css->toArray();
    	}
    	return (count($cssarr)>0?$cssarr:false);
    }
