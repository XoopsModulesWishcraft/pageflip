 ...
 * @access 		public
 */
class PageflipFormSelectBooks extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PageflipFormSelectBooks($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		foreach($books_handler->getObjects(NULL, true) as $bid => $book)
			$this->addOption($bid, $book->getVar('name'));
    }
