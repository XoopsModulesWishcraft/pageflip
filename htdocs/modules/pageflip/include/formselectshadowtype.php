 ...
 * @access 		public
 */
class PageflipFormSelectShadowsType extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function PageflipFormSelectShadowsType($caption, $name, $value = null, $size = 1, $multiple = false, $none=false)
    {
        ...
        foreach(array('_MI_PAGEFLIP_ASYMMETRIC','_MI_PAGEFLIP_SYMMETRIC','_MI_PAGEFLIP_DEFAULT') as $mode)
